...
# Alive state can be represented by other characters
ALIVE = 'O' 
# Dead state can be represented by other characters
DEAD = ' '

# The cells and nextCells are dictionaries for the state og the game.

...
PAUSE = 0.2 # Can be changed
DENSITY = 0.10 # Can be changed
...
# We can't print to the last column on Windows whitout it adding a
...
class Duckling:
    ...
    def getNextBodyPart(self):
        """Calls the appropiate display method for the next body
